...
def DBSCAN(file, minPts, distance):
            ...
            if (len(NeighborPts) >= minPts):
                ...
                while(NeighborPts!=[]):
                    for ne_item in NeighborPts:
                        # if (ne_item[0] == 52 and ne_item[1] == 159):
                        #     print("T")
                        ...
                        if ne_item in image_number:
                            ...
                            for join in ne_NeighborPts:
                                ...
                                # if ((join not in NeighborPts)):
                                #     NeighborPts.append(join)
    ...
    cv2.imwrite("screen_" + str(distance)+"_"+str(count)+ ".jpg", image_output)
